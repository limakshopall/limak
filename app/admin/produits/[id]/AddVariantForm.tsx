...
export default function AddVariantForm({ productId }: { productId: string }) {
  return (
    <form
      ...
      className="mt-3 rounded-lg border border-dashed border-[#14213D]/20 p-3 dark:border-white/15"
    >
      <input type="hidden" name="productId" value={productId} />
      <p className="mb-2 text-xs font-medium text-neutral-500 dark:text-gray-400">Ajouter une variante</p>
      ...
      <input
        ...
        className="mt-2 w-full max-w-xs rounded border border-[#14213D]/15 bg-[#FBEEDA] px-2 py-1.5 text-sm outline-none focus:border-[#F1720A] focus:ring-1 focus:ring-[#F1720A] dark:border-white/15 dark:bg-[#1c2333] dark:text-gray-300"
      />
