...
export default async function AdminProduits({
  ...
  return (
    <main className="mx-auto max-w-5xl bg-[#FBEEDA] px-4 py-8">
      ...
      <div className="overflow-x-auto rounded-xl border border-[#14213D]/10 bg-[#FFFBF3] shadow-sm">
        <table className="w-full text-sm">
          <thead className="bg-[#14213D]/5 text-left text-neutral-500">
            <tr>
          ...
          <tbody>
            {produitsTries.map((p) => {
              ...
              return (
                <tr key={p.id} className="border-t border-[#14213D]/5">
                  <td className="px-4 py-2 font-medium text-[#14213D]">{p.name}</td>
                  ...
                  <td className="px-4 py-2 text-center">
                    {p.isActive ? (
                      ...
                      <span className="text-neutral-300" title="Masqué">●</span>
                    )}
                  </td>
